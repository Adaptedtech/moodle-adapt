...
$CFG->dbhost    = $_SERVER['RDS_HOSTNAME'];  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = $_SERVER['RDS_DB_NAME'];     // database name, eg moodle
$CFG->dbuser    = $_SERVER['RDS_USERNAME'];   // your database username
$CFG->dbpass    = $_SERVER['RDS_PASSWORD'];   // your database password
...
$CFG->dataroot  = '/var/app/data/moodledata';
