...
/**
 * Privacy Subsystem implementation for theme_atacado.
 *
...
namespace theme_atacado\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($darkmodepref)) {
            $preferencestring = get_string('privacy:darkmodeoff', 'theme_atacado');
            if ($darkmodepref !== null) {
                $preferencestring = get_string('privacy:darkmodeon', 'theme_atacado');
            }
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_atacado');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_atacado');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_atacado',
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_atacado');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_atacado');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_atacado',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_atacado');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_atacado');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_atacado',
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:rightdrawerclosed', 'theme_atacado');
            if ($rightdraweropennpref !== null) {
                $preferencestring = get_string('privacy:rightdraweropen', 'theme_atacado');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_atacado',
                self::DRAWER_OPEN_NAV,
