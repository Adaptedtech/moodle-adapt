...
$THEME->scss = function ($theme) {
    return theme_atacado_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_atacado_get_extra_scss';
$THEME->prescsscallback = 'theme_atacado_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_atacado_get_precompiled_css';
$THEME->yuicssmodules = [];
