...
$string['configtitle'] = 'Atacado Theme';
...
$string['pluginname'] = 'Atacado Theme (2.5.15)';
...
$string['hintro'] = '<img src="{$a->siteurl}/theme/alpha/doc/alpha-icon.png" class="img-fluid rounded my-3" width="80" height="80" alt="Alpha Moodle Theme" /><div class="lead-3">Atacado Theme</div>';
$string['hintro_desc'] = '
