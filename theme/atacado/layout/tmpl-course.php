...
if (theme_atacado_get_setting('backtotop') == '1') {
    $extraclasses = ['back-to-top-on'];
}
// End.

// Display Admin button on the top bar.
if (theme_atacado_get_setting('topbaradminbtn') == '1') {
    $topbaradminbtn = true;
} else {
...
// Hidden sidebar.
if (theme_atacado_get_setting('turnoffsidebarcourse') == '1') {
    $hiddensidebar = true;
    $navdraweropen = false;
...
if (theme_atacado_get_setting('darkmodetheme') == '1') {
...
if (theme_atacado_get_setting('darkmodefirst') == '1') {
    $extraclasses[] = 'theme-dark';
    if (theme_atacado_get_setting('darkmodetheme') == '0') {
        $darkmodetheme = false;
    }
}
...
// Moodle 4.x.
if (theme_atacado_get_setting('hidecourseindexnav') == true) {
    $hidecourseindexnav = true;
} else {
    $hidecourseindexnav = false;
}

if (theme_atacado_get_setting('hidecourseindexnav') == false) {
...
$couseimagesettings = theme_atacado_get_setting('setcourseimage');
...
$coursepageinformationbannershtml = theme_atacado_get_course_information_banners();
...
// Load theme settings.
$themesettings = new \theme_atacado\util\theme_settings();
...
echo $OUTPUT->render_from_template('theme_atacado/tmpl-course', $templatecontext);
