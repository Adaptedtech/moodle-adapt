...
$page = new admin_settingpage('theme_atacado_block1', get_string('settingsblock1', 'theme_atacado'));

$name = 'theme_atacado/displayblock1';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock1_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #1 (Slider)</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/block1fw';
...
$name = 'theme_atacado/block1class';
...
$name = 'theme_atacado/block1wrapperalign';
$title = get_string('block1wrapperalign', 'theme_atacado');
$description = get_string('block1wrapperalign_desc', 'theme_atacado');
$default = 1;
$choices = array(0 => 'Left', 1 => 'Middle', 2 => 'Right');
$setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
$page->add($setting);

$name = 'theme_atacado/block1herotitlesize';
...
$name = 'theme_atacado/block1herotitlecolor';
...
$name = 'theme_atacado/block1herotitleweight';
...
$name = 'theme_atacado/showblock1sliderwrapper';
$title = get_string('showblock1sliderwrapper', 'theme_atacado');
$description = get_string('showblock1sliderwrapper_desc', 'theme_atacado');
$default = 1;
$setting = new admin_setting_configcheckbox($name, $title, $description, $default);
$page->add($setting);

$name = 'theme_atacado/block1sliderwrapperbg';
$title = get_string('block1sliderwrapperbg', 'theme_atacado');
$description = get_string('block1sliderwrapperbg_desc', 'theme_atacado');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_atacado/block1sliderinterval';
...
$name = 'theme_atacado/block1count';
$title = get_string('block1count', 'theme_atacado');
$description = get_string('block1count_desc', 'theme_atacado');
$default = 1;
$options = array();
for ($i = 1; $i <= 7; $i++) {
    $options[$i] = $i;
...
$slidercount = get_config('theme_atacado', 'block1count');
...
for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
    ...
    $title = get_string('hblock1slide_desc', 'theme_atacado');
    ...
    $name = 'theme_atacado/block1slideimg' . $sliderindex;
    $title = get_string('block1slideimg', 'theme_atacado');
    $description = get_string('block1slideimg_desc', 'theme_atacado');
    ...
    $name = 'theme_atacado/block1slidetitle' . $sliderindex;
    $title = get_string('block1slidetitle', 'theme_atacado');
    $description = get_string('block1slidetitle_desc', 'theme_atacado');
    ...
    $name = 'theme_atacado/block1slidecaption' . $sliderindex;
    $title = get_string('block1slidecaption', 'theme_atacado');
    $description = get_string('block1slidecaption_desc', 'theme_atacado');
...
<a href="https://rosea.io/alpha-theme/" target="_blank" class="btn btn-sm btn-light my-1 mx-0">Alpha 1.15 for Moodle 3.9 - 3.11</a>
    ...
    $name = 'theme_atacado/block1slidecss' . $sliderindex;
    $title = get_string('block1slidecss', 'theme_atacado');
    $description = get_string('block1slidecss_desc', 'theme_atacado');
