...
$page = new admin_settingpage('theme_atacado_block10', get_string('settingsblock10', 'theme_atacado'));

$name = 'theme_atacado/displayblock10';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock10_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #10</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock10';
...
$name = 'theme_atacado/block10class';
...
$name = 'theme_atacado/block10introtitle';
...
$name = 'theme_atacado/block10introcontent';
...
$name = 'theme_atacado/block10htmlcontent';
...
$name = 'theme_atacado/block10footercontent';
