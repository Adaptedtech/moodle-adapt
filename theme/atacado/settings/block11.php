...
$page = new admin_settingpage('theme_atacado_block11', get_string('settingsblock11', 'theme_atacado'));

$name = 'theme_atacado/displayblock11';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock11_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #11</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock11';
...
$name = 'theme_atacado/block11class';
...
$name = 'theme_atacado/block11introtitle';
...
$name = 'theme_atacado/block11introcontent';
...
$name = 'theme_atacado/block11htmlcontent';
...
$name = 'theme_atacado/block11footercontent';
