...
$page = new admin_settingpage('theme_atacado_block12', get_string('settingsblock12', 'theme_atacado'));

$name = 'theme_atacado/displayblock12';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock12_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #12</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock12';
...
$name = 'theme_atacado/block12class';
...
$name = 'theme_atacado/block12introtitle';
...
$name = 'theme_atacado/block12introcontent';
...
$name = 'theme_atacado/block12htmlcontent';
...
$name = 'theme_atacado/block12footercontent';
