...
$page = new admin_settingpage('theme_atacado_block13', get_string('settingsblock13', 'theme_atacado'));

$name = 'theme_atacado/displayblock13';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock13_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #13</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock13';
...
$name = 'theme_atacado/block13class';
...
$name = 'theme_atacado/block13textalign';
$title = get_string('block13textalign', 'theme_atacado');
$description = get_string('block13textalign_desc', 'theme_atacado');
$options = [];
...
$name = 'theme_atacado/block13titlesize';
...
$name = 'theme_atacado/block13titlecolor';
...
$name = 'theme_atacado/block13titleweight';
...
$name = 'theme_atacado/block13introtitle';
...
$name = 'theme_atacado/block13introcontent';
...
$name = 'theme_atacado/block13htmlcontent';
...
$name = 'theme_atacado/block13footercontent';
...
$fileid = 'block13bg';
$name = 'theme_atacado/block13bg';
$title = get_string('block13bg', 'theme_atacado');
$description = get_string('block13bg_desc', 'theme_atacado');
$opts = array('accepted_types' => array('.png', '.jpg', '.gif', '.webp', '.tiff', '.svg'), 'maxfiles' => 1);
$setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_atacado/block13customcss';
$title = get_string('block13customcss', 'theme_atacado');
$description = get_string('block13customcss_desc', 'theme_atacado');
$default = '';
$setting = new admin_setting_configtextarea($name, $title, $description, $default);
$page->add($setting);
