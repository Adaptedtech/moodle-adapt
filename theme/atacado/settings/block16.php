...
$page = new admin_settingpage('theme_atacado_block16', get_string('settingsblock16', 'theme_atacado'));

$name = 'theme_atacado/displayblock16';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock16_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #16</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock16';
...
$name = 'theme_atacado/block16class';
...
$name = 'theme_atacado/block16introtitle';
...
$name = 'theme_atacado/block16introcontent';
...
$name = 'theme_atacado/block16htmlcontent';
...
$name = 'theme_atacado/block16footercontent';
...
$name = 'theme_atacado/block16customcss';
