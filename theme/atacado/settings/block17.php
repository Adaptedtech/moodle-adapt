...
$page = new admin_settingpage('theme_atacado_block17', get_string('settingsblock17', 'theme_atacado'));

$name = 'theme_atacado/displayblock17';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock17_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #17</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock17';
...
$name = 'theme_atacado/block17class';
...
$name = 'theme_atacado/block17introtitle';
...
$name = 'theme_atacado/block17introcontent';
...
$name = 'theme_atacado/block17htmlcontent';
...
$name = 'theme_atacado/block17footercontent';
...
$name = 'theme_atacado/block17customcss';
