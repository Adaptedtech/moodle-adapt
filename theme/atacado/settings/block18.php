...
$page = new admin_settingpage('theme_atacado_block18', get_string('settingsblock18', 'theme_atacado'));

$name = 'theme_atacado/displayblock18';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock18_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #18</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock18';
...
$name = 'theme_atacado/block18class';
...
$name = 'theme_atacado/block18introtitle';
...
$name = 'theme_atacado/block18introcontent';
...
$name = 'theme_atacado/block18htmlcontent';
$title = get_string('blockhtmlcontent', 'theme_atacado');
$description = get_string('block18htmlcontent_desc', 'theme_atacado');
...
$name = 'theme_atacado/block18footercontent';
