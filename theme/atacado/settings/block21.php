...
$page = new admin_settingpage('theme_atacado_block21', get_string('settingsblock21', 'theme_atacado'));

$name = 'theme_atacado/displayblock21';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock21_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #21</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock21';
...
$name = 'theme_atacado/block21class';
...
$name = 'theme_atacado/block21introtitle';
...
$name = 'theme_atacado/block21introcontent';
...
$name = 'theme_atacado/block21htmlcontent';
...
$name = 'theme_atacado/block21footercontent';
