...
$page = new admin_settingpage('theme_atacado_block6', get_string('settingsblock6', 'theme_atacado'));

$name = 'theme_atacado/displayblock6';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock6_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #6</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock6';
...
$name = 'theme_atacado/block6class';
...
$name = 'theme_atacado/block6introtitle';
...
$name = 'theme_atacado/block6introcontent';
...
$name = 'theme_atacado/block6htmlcontent';
...
$name = 'theme_atacado/block6footercontent';
