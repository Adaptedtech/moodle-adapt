...
$page = new admin_settingpage('theme_atacado_block7', get_string('settingsblock7', 'theme_atacado'));

$name = 'theme_atacado/displayblock7';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock7_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #7</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock7';
...
$name = 'theme_atacado/block7class';
...
$name = 'theme_atacado/block7introtitle';
...
$name = 'theme_atacado/block7introcontent';
...
$name = 'theme_atacado/block7htmlcontent';
...
$name = 'theme_atacado/block7footercontent';
