...
$page = new admin_settingpage('theme_atacado_block8', get_string('settingsblock8', 'theme_atacado'));

$name = 'theme_atacado/displayblock8';
$title = get_string('turnon', 'theme_atacado');
$description = get_string('displayblock8_desc', 'theme_atacado');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #8</span>', $description, $default);
$page->add($setting);

$name = 'theme_atacado/displayhrblock8';
...
$name = 'theme_atacado/block8class';
...
$name = 'theme_atacado/block8introtitle';
...
$name = 'theme_atacado/block8introcontent';
...
$name = 'theme_atacado/block8htmlcontent';
...
$name = 'theme_atacado/block8footercontent';
