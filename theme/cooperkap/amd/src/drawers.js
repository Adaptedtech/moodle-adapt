...
export default class Drawers {
    ...
    static eventTypes = {
         ...
         */
        drawerShow: 'theme_cooperkap/drawers:show',
         ...
         */
        drawerShown: 'theme_cooperkap/drawers:shown',
         ...
         */
        drawerHide: 'theme_cooperkap/drawers:hide',
         ...
         */
        drawerHidden: 'theme_cooperkap/drawers:hidden',
    };
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_cooperkap/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_cooperkap/drawers:close');
