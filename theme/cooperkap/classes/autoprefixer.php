 ...
 * theme space when working with Bootstrap 4 cooperkap. We do not recommend
...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_cooperkap\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
