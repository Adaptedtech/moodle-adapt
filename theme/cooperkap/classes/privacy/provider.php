...
/**
 * Privacy Subsystem implementation for theme_cooperkap.
 *
...
namespace theme_cooperkap\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($darkmodepref)) {
            $preferencestring = get_string('privacy:darkmodeoff', 'theme_cooperkap');
            if ($darkmodepref !== null) {
                $preferencestring = get_string('privacy:darkmodeon', 'theme_cooperkap');
            }
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_cooperkap');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_cooperkap');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_cooperkap',
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_cooperkap');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_cooperkap');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_cooperkap',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_cooperkap');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_cooperkap');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_cooperkap',
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:rightdrawerclosed', 'theme_cooperkap');
            if ($rightdraweropennpref !== null) {
                $preferencestring = get_string('privacy:rightdraweropen', 'theme_cooperkap');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_cooperkap',
                self::DRAWER_OPEN_NAV,
