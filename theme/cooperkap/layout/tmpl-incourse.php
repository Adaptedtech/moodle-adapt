...
if (theme_cooperkap_get_setting('topbaradminbtn') == '1') {
    $topbaradminbtn = true;
} else {
...
// Hidden sidebar.
if (theme_cooperkap_get_setting('turnoffsidebarincourse') == '1') {
    $hiddensidebar = true;
    $navdraweropen = false;
...
// Moodle 4.x.
if (theme_cooperkap_get_setting('hidecourseindexnav') == true) {
    $hidecourseindexnav = true;
} else {
    $hidecourseindexnav = false;
}

if (theme_cooperkap_get_setting('hidecourseindexnav') == false) {
...
$coursepageinformationbannershtml = theme_cooperkap_get_course_information_banners();
...
// Load theme settings.
$themesettings = new \theme_cooperkap\util\theme_settings();
...
echo $OUTPUT->render_from_template('theme_cooperkap/tmpl-incourse', $templatecontext);
