 ...
 * @return string
 */
function theme_cooperkap_get_setting($setting, $format = false) {
 ...
 */
function theme_cooperkap_css_tree_post_processor($tree, $theme) {
    debugging('theme_cooperkap_css_tree_post_processor() is deprecated. Required' .
        'prefixes for Bootstrap are now in theme/cooperkap/scss/moodle/prefixes.scss');
    $prefixer = new theme_cooperkap\autoprefixer($tree);
    $prefixer->prefix();
}
 ...
 * @return array[]
 */
function theme_cooperkap_user_preferences(): array {
    return [
        'drawer-open-block' => [
            'type' => PARAM_BOOL,
 ...
 * @return string
 */
function theme_cooperkap_get_extra_scss($theme) {
    $content = '';

    // Sets the login background image.
    // Check login layout, only layout #1 has background image.
    $loginlayout = theme_cooperkap_get_setting('setloginlayout');
 ...
 * @return bool
 */
function theme_cooperkap_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        ...
        if ($filearea === 'hvp') {
            return theme_cooperkap_serve_hvp_css($args[1], $theme);
        }
        if ($filearea === 'favicon') {
 ...
 */
function theme_cooperkap_setting_file_url($setting, $filearea, $theme) {
    global $CFG;

    $component = 'theme_cooperkap';
    $itemid = 0;
 ...
 * @return string
 */
function theme_cooperkap_get_main_scss_content($theme) {
    global $CFG;
 ...
 * @return array
 */
function theme_cooperkap_get_pre_scss($theme) {
    global $CFG;
 ...
 * @return string.
 */
function theme_cooperkap_get_course_guest_access_hint($courseid) {
    global $CFG;
 ...
 * @return string.
 */
function theme_cooperkap_get_course_information_banners() {
    ...
    if (get_config('theme_cooperkap', 'showhintcoursehidden') == 1
            && $allowtoshowhint == true
            && $PAGE->has_set_url()
        ...
        $html .= $OUTPUT->render_from_template('theme_cooperkap/course-hint-hidden', $templatecontext);
    }
    ...
    // intended.
    if (get_config('theme_cooperkap', 'showhintcourseguestaccess') == 1
        ...
        // Render template and add it to HTML code.
        $html .= $OUTPUT->render_from_template('theme_cooperkap/course-hint-guestaccess', $templatecontext);
    }
    ...
    if (get_config('theme_cooperkap', 'showhintcourseselfenrol') == 1
        ...
        if (!empty($selfenrolinstances) &&
            ...
            if ($selfenrolmentpossiblecurrently == true) {
                $templatecontext['selfenrolhintstart'] = get_string('showhintcourseselfenrolstartcurrently', 'theme_cooperkap');
            } else if ($selfenrolmentpossiblefuture == true) {
                $templatecontext['selfenrolhintstart'] = get_string('showhintcourseselfenrolstartfuture', 'theme_cooperkap');
            }
            ...
            foreach ($selfenrolinstances as $selfenrolinstanceid => $selfenrolinstanceobject) {
                ...
                if ($selfenrolinstanceobject->unrestrictedness == 'unlimited') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolunlimited', 'theme_cooperkap',
                            array('name' => $selfenrolinstanceobject->name));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'until') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenroluntil', 'theme_cooperkap',
                            array('name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'from') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolfrom', 'theme_cooperkap',
                            array('name' => $selfenrolinstanceobject->name,
                                    'from' => userdate($selfenrolinstanceobject->startdate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'since') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolsince', 'theme_cooperkap',
                            array('name' => $selfenrolinstanceobject->name,
                                    'since' => userdate($selfenrolinstanceobject->startdate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'fromuntil') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolfromuntil', 'theme_cooperkap',
                            array('name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate),
                                    'from' => userdate($selfenrolinstanceobject->startdate)));
                } else if ($selfenrolinstanceobject->unrestrictedness == 'sinceuntil') {
                    $templatecontext['selfenrolinstances'][] = get_string('showhintcourseselfenrolsinceuntil', 'theme_cooperkap',
                            array('name' => $selfenrolinstanceobject->name,
                                    'until' => userdate($selfenrolinstanceobject->enddate),
                                    'since' => userdate($selfenrolinstanceobject->startdate)));
                }
            ...
            // Render template and add it to HTML code.
            $html .= $OUTPUT->render_from_template('theme_cooperkap/course-hint-selfenrol', $templatecontext);
        }
    }
    ...
    if (get_config('theme_cooperkap', 'showswitchedroleincourse') == 1
            && is_role_switched($COURSE->id) ) {
        ...
        // Render template and add it to HTML code.
        $html .= $OUTPUT->render_from_template('theme_cooperkap/course-hint-switchedrole', $templatecontext);
    }
 ...
 * @throws dml_exception
 */
function theme_cooperkap_serve_hvp_css($filename, $theme) {
    global $CFG, $PAGE;
    ...
    $settings = new \theme_cooperkap\util\theme_settings();
    $content = $settings->hvpcss;

    $md5content = md5($content);
    $md5stored = get_config('theme_cooperkap', 'hvpccssmd5');
