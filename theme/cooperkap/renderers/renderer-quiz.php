...
class theme_cooperkap_mod_quiz_renderer extends mod_quiz\output\renderer {
    /**
     * Outputs a box.
     *
     ...
     */
    public function cooperkap_box($contents, $classes = 'generalbox', $id = null, $attributes = array()) {
        return $this->cooperkap_box_start($classes, $id, $attributes) . $contents . $this->cooperkap_box_end();
    }
     ...
     * @return string the HTML to output.
     */
    public function cooperkap_box_start($classes = 'generalbox', $id = null, $attributes = array()) {
     ...
     * @return string the HTML to output.
     */
    public function cooperkap_box_end() {
...
class theme_cooperkap_core_question_renderer extends core_question_renderer {
    /**
