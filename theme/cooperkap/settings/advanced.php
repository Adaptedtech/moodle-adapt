...
$setting = new admin_setting_scsscode(
    'theme_cooperkap/scsspre',
    get_string('rawscsspre', 'theme_cooperkap'),
    get_string('rawscsspre_desc', 'theme_cooperkap'),
    '',
    PARAM_RAW
);
...
$setting = new admin_setting_scsscode(
    'theme_cooperkap/scss',
    get_string('rawscss', 'theme_cooperkap'),
    get_string('rawscss_desc', 'theme_cooperkap'),
    '',
    PARAM_RAW
);
$setting->set_updatedcallback('theme_reset_all_caches');
...
// Font files upload.
$name = 'theme_cooperkap/fontfiles';
$title = get_string('fontfilessetting', 'theme_cooperkap', null, true);
$description = get_string('fontfilessetting_desc', 'theme_cooperkap', null, true);
