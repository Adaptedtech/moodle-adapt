...
$page = new admin_settingpage('theme_cooperkap_block1', get_string('settingsblock1', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock1';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock1_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #1 (Slider)</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/block1fw';
...
$name = 'theme_cooperkap/block1class';
...
$name = 'theme_cooperkap/block1wrapperalign';
$title = get_string('block1wrapperalign', 'theme_cooperkap');
$description = get_string('block1wrapperalign_desc', 'theme_cooperkap');
$default = 1;
$choices = array(0 => 'Left', 1 => 'Middle', 2 => 'Right');
$setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
$page->add($setting);

$name = 'theme_cooperkap/block1herotitlesize';
...
$name = 'theme_cooperkap/block1herotitlecolor';
...
$name = 'theme_cooperkap/block1herotitleweight';
...
$name = 'theme_cooperkap/showblock1sliderwrapper';
$title = get_string('showblock1sliderwrapper', 'theme_cooperkap');
$description = get_string('showblock1sliderwrapper_desc', 'theme_cooperkap');
$default = 1;
$setting = new admin_setting_configcheckbox($name, $title, $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/block1sliderwrapperbg';
$title = get_string('block1sliderwrapperbg', 'theme_cooperkap');
$description = get_string('block1sliderwrapperbg_desc', 'theme_cooperkap');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_cooperkap/block1sliderinterval';
...
$name = 'theme_cooperkap/block1count';
$title = get_string('block1count', 'theme_cooperkap');
$description = get_string('block1count_desc', 'theme_cooperkap');
$default = 1;
$options = array();
for ($i = 1; $i <= 7; $i++) {
    $options[$i] = $i;
...
$slidercount = get_config('theme_cooperkap', 'block1count');
...
for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
    ...
    $title = get_string('hblock1slide_desc', 'theme_cooperkap');
    ...
    $name = 'theme_cooperkap/block1slideimg' . $sliderindex;
    $title = get_string('block1slideimg', 'theme_cooperkap');
    $description = get_string('block1slideimg_desc', 'theme_cooperkap');
    ...
    $name = 'theme_cooperkap/block1slidetitle' . $sliderindex;
    $title = get_string('block1slidetitle', 'theme_cooperkap');
    $description = get_string('block1slidetitle_desc', 'theme_cooperkap');
    ...
    $name = 'theme_cooperkap/block1slidecaption' . $sliderindex;
    $title = get_string('block1slidecaption', 'theme_cooperkap');
    $description = get_string('block1slidecaption_desc', 'theme_cooperkap');
...
<a href="https://rosea.io/alpha-theme/" target="_blank" class="btn btn-sm btn-light my-1 mx-0">Alpha 1.15 for Moodle 3.9 - 3.11</a>
    ...
    $name = 'theme_cooperkap/block1slidecss' . $sliderindex;
    $title = get_string('block1slidecss', 'theme_cooperkap');
    $description = get_string('block1slidecss_desc', 'theme_cooperkap');
