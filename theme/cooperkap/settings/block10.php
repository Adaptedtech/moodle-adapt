...
$page = new admin_settingpage('theme_cooperkap_block10', get_string('settingsblock10', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock10';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock10_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #10</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock10';
...
$name = 'theme_cooperkap/block10class';
...
$name = 'theme_cooperkap/block10introtitle';
...
$name = 'theme_cooperkap/block10introcontent';
...
$name = 'theme_cooperkap/block10htmlcontent';
