...
$page = new admin_settingpage('theme_cooperkap_block11', get_string('settingsblock11', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock11';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock11_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #11</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock11';
...
$name = 'theme_cooperkap/block11class';
...
$name = 'theme_cooperkap/block11introtitle';
...
$name = 'theme_cooperkap/block11introcontent';
...
$name = 'theme_cooperkap/block11htmlcontent';
