...
$page = new admin_settingpage('theme_cooperkap_block12', get_string('settingsblock12', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock12';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock12_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #12</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock12';
...
$name = 'theme_cooperkap/block12class';
...
$name = 'theme_cooperkap/block12introtitle';
...
$name = 'theme_cooperkap/block12introcontent';
...
$name = 'theme_cooperkap/block12htmlcontent';
