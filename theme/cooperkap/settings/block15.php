...
$page = new admin_settingpage('theme_cooperkap_block15', get_string('settingsblock15', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock15';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock15_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #15</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock15';
...
$name = 'theme_cooperkap/block15class';
...
$name = 'theme_cooperkap/block15introtitle';
...
$name = 'theme_cooperkap/block15introcontent';
...
$name = 'theme_cooperkap/block15htmlcontent';
...
$fileid = 'block15bg';
$name = 'theme_cooperkap/block15bg';
...
$name = 'theme_cooperkap/block15customcss';
