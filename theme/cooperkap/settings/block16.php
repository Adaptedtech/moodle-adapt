...
$page = new admin_settingpage('theme_cooperkap_block16', get_string('settingsblock16', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock16';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock16_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #16</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock16';
...
$name = 'theme_cooperkap/block16class';
...
$name = 'theme_cooperkap/block16introtitle';
...
$name = 'theme_cooperkap/block16introcontent';
...
$name = 'theme_cooperkap/block16htmlcontent';
...
$fileid = 'block16bg';
$name = 'theme_cooperkap/block16bg';
...
$name = 'theme_cooperkap/block16customcss';
