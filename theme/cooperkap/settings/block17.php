...
$page = new admin_settingpage('theme_cooperkap_block17', get_string('settingsblock17', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock17';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock17_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #17</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock17';
...
$name = 'theme_cooperkap/block17class';
...
$name = 'theme_cooperkap/block17introtitle';
...
$name = 'theme_cooperkap/block17introcontent';
...
$name = 'theme_cooperkap/block17htmlcontent';
...
$name = 'theme_cooperkap/block17footercontent';
...
$fileid = 'block17bg';
$name = 'theme_cooperkap/block17bg';
$title = get_string('blockbg', 'theme_cooperkap');
$description = get_string('blockbg_desc', 'theme_cooperkap');
$opts = array('accepted_types' => array('.png', '.jpg', '.gif', '.webp', '.tiff', '.svg'), 'maxfiles' => 1);
$setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_cooperkap/block17customcss';
$title = get_string('blockcustomcss', 'theme_cooperkap');
$description = get_string('blockcustomcss_desc', 'theme_cooperkap');
$default = '';
$setting = new admin_setting_configtextarea($name, $title, $description, $default);
$page->add($setting);
