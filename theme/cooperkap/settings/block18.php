...
$page = new admin_settingpage('theme_cooperkap_block18', get_string('settingsblock18', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock18';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock18_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #18</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock18';
...
$name = 'theme_cooperkap/block18class';
...
$name = 'theme_cooperkap/block18introtitle';
...
$name = 'theme_cooperkap/block18introcontent';
...
$name = 'theme_cooperkap/block18htmlcontent';
$title = get_string('blockhtmlcontent', 'theme_cooperkap');
$description = get_string('block18htmlcontent_desc', 'theme_cooperkap');
