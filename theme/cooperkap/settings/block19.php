...
$page = new admin_settingpage('theme_cooperkap_block19', get_string('settingsblock19', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock19';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock19_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #19</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/block19class';
...
$name = 'theme_cooperkap/block19textalign';
$title = get_string('block19textalign', 'theme_cooperkap');
$description = get_string('block19textalign_desc', 'theme_cooperkap');
$options = [];
...
$name = 'theme_cooperkap/block19titlesize';
...
$name = 'theme_cooperkap/block19titlecolor';
...
$name = 'theme_cooperkap/block19titleweight';
...
$name = 'theme_cooperkap/displayhrblock19';
...
$name = 'theme_cooperkap/block19introtitle';
...
$name = 'theme_cooperkap/block19introcontent';
...
$name = 'theme_cooperkap/block19htmlcontent';
...
$name = 'theme_cooperkap/block19footercontent';
...
$fileid = 'block19bg';
$name = 'theme_cooperkap/block19bg';
$title = get_string('block19bg', 'theme_cooperkap');
$description = get_string('block19bg_desc', 'theme_cooperkap');
$opts = array('accepted_types' => array('.png', '.jpg', '.gif', '.webp', '.tiff', '.svg'), 'maxfiles' => 1);
$setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_cooperkap/block19customcss';
$title = get_string('block19customcss', 'theme_cooperkap');
$description = get_string('block19customcss_desc', 'theme_cooperkap');
