...
$page = new admin_settingpage('theme_cooperkap_block21', get_string('settingsblock21', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock21';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock21_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #21</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock21';
...
$name = 'theme_cooperkap/block21class';
...
$name = 'theme_cooperkap/block21introtitle';
...
$name = 'theme_cooperkap/block21introcontent';
...
$name = 'theme_cooperkap/block21htmlcontent';
