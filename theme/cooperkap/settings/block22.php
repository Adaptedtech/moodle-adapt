...
$page = new admin_settingpage('theme_cooperkap_block22', get_string('settingsblock22', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock22';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock22_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #22</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock22';
...
$name = 'theme_cooperkap/block22class';
...
$name = 'theme_cooperkap/block22introtitle';
...
$name = 'theme_cooperkap/block22introcontent';
...
$name = 'theme_cooperkap/block22htmlcontent';
