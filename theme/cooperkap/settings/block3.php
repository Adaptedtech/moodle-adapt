...
$page = new admin_settingpage('theme_cooperkap_block3', get_string('settingsblock3', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock3';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock3_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #3 (Hero Image)</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/block3fw';
...
$name = 'theme_cooperkap/block3class';
...
$name = 'theme_cooperkap/block3wrapperalign';
$title = get_string('block3wrapperalign', 'theme_cooperkap');
$description = get_string('block3wrapperalign_desc', 'theme_cooperkap');
$default = 1;
$choices = array(0 => 'Left', 1 => 'Middle', 2 => 'Right');
$setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
$page->add($setting);

$name = 'theme_cooperkap/showblock3wrapper';
$title = get_string('showblock3wrapper', 'theme_cooperkap');
$description = get_string('showblock3wrapper_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title, $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/block3wrapperbg';
$title = get_string('block3wrapperbg', 'theme_cooperkap');
$description = get_string('block3wrapperbg_desc', 'theme_cooperkap');
$setting = new admin_setting_configcolourpicker($name, $title, $description, '');
$setting->set_updatedcallback('theme_reset_all_caches');
$page->add($setting);

$name = 'theme_cooperkap/block3introcontent';
...
$name = 'theme_cooperkap/block3herotitle';
$title = get_string('block3herotitle', 'theme_cooperkap');
$description = get_string('block3herotitle_desc', 'theme_cooperkap');
$setting = new admin_setting_configtextarea($name, $title, $description, '', PARAM_TEXT);
$page->add($setting);

$name = 'theme_cooperkap/block3herosubheading';
$title = get_string('block3herosubheading', 'theme_cooperkap');
$description = get_string('block3herosubheading_desc', 'theme_cooperkap');
$setting = new admin_setting_configtextarea($name, $title, $description, '', PARAM_TEXT);
$page->add($setting);

$name = 'theme_cooperkap/block3herotitlesize';
...
$name = 'theme_cooperkap/block3herotitlecolor';
...
$name = 'theme_cooperkap/block3herotitleweight';
...
$name = 'theme_cooperkap/block3herocaption';
$title = get_string('block3herocaption', 'theme_cooperkap');
$description = get_string('block3herocaption_desc', 'theme_cooperkap');
...
$name = 'theme_cooperkap/block3img';
$title = get_string('block3img', 'theme_cooperkap');
$description = get_string('block3img_desc', 'theme_cooperkap');
...
$name = 'theme_cooperkap/block3htmlcontent';
...
$name = 'theme_cooperkap/block3footercontent';
