...
$page = new admin_settingpage('theme_cooperkap_block7', get_string('settingsblock7', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock7';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock7_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #7</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock7';
...
$name = 'theme_cooperkap/block7class';
...
$name = 'theme_cooperkap/block7introtitle';
...
$name = 'theme_cooperkap/block7introcontent';
...
$name = 'theme_cooperkap/block7htmlcontent';
