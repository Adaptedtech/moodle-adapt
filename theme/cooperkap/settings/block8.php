...
$page = new admin_settingpage('theme_cooperkap_block8', get_string('settingsblock8', 'theme_cooperkap'));

$name = 'theme_cooperkap/displayblock8';
$title = get_string('turnon', 'theme_cooperkap');
$description = get_string('displayblock8_desc', 'theme_cooperkap');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #8</span>', $description, $default);
$page->add($setting);

$name = 'theme_cooperkap/displayhrblock8';
...
$name = 'theme_cooperkap/block8class';
...
$name = 'theme_cooperkap/block8introtitle';
...
$name = 'theme_cooperkap/block8introcontent';
...
$name = 'theme_cooperkap/block8htmlcontent';
